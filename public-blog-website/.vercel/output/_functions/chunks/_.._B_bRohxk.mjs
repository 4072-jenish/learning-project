...
import 'piccolore';
import { r as renderComponent, b as renderHead, e as addAttribute, c as renderTemplate } from './entrypoint_CRv9opb3.mjs';
import { r as renderScript } from './script_BHP2p-EY.mjs';
import { c as createLucideIcon, $ as $$BaseHead, a as $$Header, b as $$Footer } from './Header_DHPYy86p.mjs';
import { $ as $$FormattedDate } from './FormattedDate_ttTLJLjp.mjs';
import { S as SITE_TITLE } from './consts_BuHq6iFx.mjs';
import { H as Heart, M as MessageCircle } from './message-circle_Bx0EXZzD.mjs';
...
const $$ = createComponent(async ($$result, $$props, $$slots) => {
  ...
  const res = await fetch(
    `${"https://learning-project-279l.onrender.com/"}blog/${blogId}`
  );
  if (!res.ok) {
